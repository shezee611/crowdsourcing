            ...
            <div class="box-header">
              ...
              <div class="box-body">
               ...
               <%@ page import="INSE6260.TasksClass" %>
                ...
                TasksClass tempx;
               ArrayList<TasksClass> alx = objx.select("where id in(select taskid from assignedtask where workerid in("+Integer.parseInt(session.getAttribute("sess_user_id").toString())+") and status=0)");               
