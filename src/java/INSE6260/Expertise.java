 ...
 * @author khurram
 */
public class Expertise extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             ExpertiesClass obj = new ExpertiesClass();
             ...
             String result = obj.insert(str_name,Integer.parseInt(session.getAttribute("sess_user_id").toString()));              
